...
public class PreWorkoutRoutines extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_workout_routines);

        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Pre-workout activities</font>"));
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(PreWorkoutRoutines.this, ExercisesView.class);
