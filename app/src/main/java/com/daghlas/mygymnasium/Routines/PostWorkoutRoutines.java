...
public class PostWorkoutRoutines extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_workout_routines);
        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Post-workout activities</font>"));
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(PostWorkoutRoutines.this, ExercisesView.class);
