...
public class ButtLegWednesday extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butt_leg_wednesday);

        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Wednesday - Butt & Legs</font>"));
    ...
    private void setUpExercisesModel() {
        String[] exerciseName = getResources().getStringArray(R.array.wednesday_butt_leg);
        String[] exerciseDuration = getResources().getStringArray(R.array.wednesday_butt_leg_duration);
        String[] exerciseDescription = getResources().getStringArray(R.array.wednesday_butt_leg_description);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ButtLegWednesday.this, ButtLegWorkout.class);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(ButtLegWednesday.this, ExercisesView.class);
