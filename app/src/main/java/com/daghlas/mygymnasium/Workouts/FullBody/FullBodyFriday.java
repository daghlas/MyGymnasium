...
public class FullBodyFriday extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_body_friday);

        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Friday - Full Body</font>"));
    ...
    private void setUpExercisesModel() {
        String[] exerciseName = getResources().getStringArray(R.array.friday_full_body);
        String[] exerciseDuration = getResources().getStringArray(R.array.friday_full_body_duration);
        String[] exerciseDescription = getResources().getStringArray(R.array.friday_full_body_description);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(FullBodyFriday.this, FullBodyWorkout.class);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(FullBodyFriday.this, ExercisesView.class);
