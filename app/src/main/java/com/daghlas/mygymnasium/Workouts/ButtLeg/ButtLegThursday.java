...
public class ButtLegThursday extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butt_leg_thursday);

        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Thursday - Butt & Legs</font>"));
    ...
    private void setUpExercisesModel() {
        String[] exerciseName = getResources().getStringArray(R.array.tuesday_butt_leg);
        String[] exerciseDuration = getResources().getStringArray(R.array.tuesday_butt_leg_duration);
        String[] exerciseDescription = getResources().getStringArray(R.array.tuesday_butt_leg_description);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ButtLegThursday.this, ButtLegWorkout.class);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(ButtLegThursday.this, ExercisesView.class);
