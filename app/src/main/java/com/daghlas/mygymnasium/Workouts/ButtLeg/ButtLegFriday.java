...
public class ButtLegFriday extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butt_leg_friday);

        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Friday - Butt & Legs</font>"));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ButtLegFriday.this, ButtLegWorkout.class);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(ButtLegFriday.this, ExercisesView.class);
