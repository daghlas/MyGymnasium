...
public class AbsArmsFriday extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abs_arms_friday);

        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Friday - Abs & Arms</font>"));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AbsArmsFriday.this, AbsArmsWorkout.class);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(AbsArmsFriday.this, ExercisesView.class);
