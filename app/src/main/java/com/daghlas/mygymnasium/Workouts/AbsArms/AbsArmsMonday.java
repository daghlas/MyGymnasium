...
public class AbsArmsMonday extends AppCompatActivity implements WorkoutsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abs_arms_monday);

        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.blue));

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFFFF'>Monday - Abs & Arms</font>"));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AbsArmsMonday.this, AbsArmsWorkout.class);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(AbsArmsMonday.this, ExercisesView.class);
